...
function About() {
  ...
  // Hover play handling (catches browser autoplay rejection)
        ...
        <div className="container">
          <div className="video-content-wrapper">
            ...
            <div className="video-text-content">
              ...
              <button
                type="button"
                className={`read-more-btn ${isReadMoreOpen ? "is-open" : ""}`}
              ...
              >
                <div className="read-more-details-inner">
                  ...
                  <p>
                    ...
                    scalable technology to create digital products that are easy to use
                  ...
                  <div className="details-list">
                    <div className="detail-item">
                      ...
                      <div>
                        ...
                        <p>
                          Responsive and production-ready websites and applications
                    ...
                    <div className="detail-item">
                      ...
                      <div>
                        ...
                        <p>
                          Clean, intuitive interfaces that provide a smooth experience
                    ...
                    <div className="detail-item">
                      ...
                      <div>
                        ...
                        <p>
                          Technology solutions designed to reduce repetitive work,
